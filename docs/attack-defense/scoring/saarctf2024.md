...
- Only small differences to the [FaustCTF 2024](faust2024.md) scoring formula,
...
- Defense points scale with SLA, such that perfect SLA will always be worth
  ...
  violates [Tenet 4](tenets.md#perfect_sla_must_be_worth_more_than_any_attackers_relative_gain).
