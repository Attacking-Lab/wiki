...
- Only small differences to [FaustCTF 2024](faust2024.md) and [SaarCTF 2024](saarctf2024.md),
...
- Flag value is scaled by the number of flag stores of each service, not
  ...
  [Tenet 7](tenets.md#flag_value_should_be_calculated_independent_of_its_flagstore)
