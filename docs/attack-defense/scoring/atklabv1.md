...
[Tenet 6](tenets.md#sla_should_decrease_fairly_with_every_missing_flag_in_the_retention_period).
...
- Captured flags' value scales with the number of captures, therefore this
  formula suffers from the same quirk as [FaustCTF 2024](faust2024.md) and similar,
